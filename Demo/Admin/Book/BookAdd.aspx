<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookAdd.aspx.cs" Inherits="Demo.Admin.Book.BookAdd" %>
    ...
    <form id="form1" runat="server">
          <table style="width:1000px; margin-top:0px;" class="MyTable">
            ...
            <tr>
                <td class="lefttd">&nbsp;</td>
                <td colspan="3">
                    <asp:Button ID="btAdd" ClientIDMode="static" runat="server" Text="新增图书" OnClick="btAdd_Click" OnClientClick="boiii()" />
                </td>
            </tr>
        </table>
    </form>
