<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserPower.aspx.cs" Inherits="Demo.Admin.User.UserPower" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>   
     <title>用户权限</title>
        ...
        <script src="../../js/jquery.js" type="text/javascript"></script>
	        ...
	        $(function () {
	            var RolePowerList = '<%=ViewState["UserPowerList"]%>';
...
<body>
    <form id="form1" runat="server">
        <div>
        </div><div id="divPowerTitle" class="divtitle">权限配置-<asp:Label ID="Label1" runat="server" Text=""></asp:Label></div>
        <div>
