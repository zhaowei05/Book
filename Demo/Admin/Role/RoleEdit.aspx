<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleEdit.aspx.cs" Inherits="Demo.Admin.Role.RoleEdit" %>
...
<body>
    <form id="form1" runat="server">
         <table style="width:800px; margin-top:0px;" class="MyTable">
            <tr class="titletr"><td colspan="2" style="text-align:center;">角色编辑</td></tr>
            <tr>
            ...
            <tr>
                <td class="lefttd">&nbsp;</td>
                <td>
                    <asp:Button ID="btUpdate" ClientIDMode="Static" runat="server" Text="修改角色" OnClick="btUpdate_Click" />
                </td>
            </tr>
        </table>
    </form>
