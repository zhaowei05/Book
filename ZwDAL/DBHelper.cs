...
namespace ZwDAL
{
    public class DBHelper
    {
        ...
        //public static string connStr = "server=.;database=DB1702;uid=sa;pwd=123456;";

        //SQL连接字符串-Windows身份认证方式登录
        // public static string connStr = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=DB1702";
        ...
        public string connStr = ConfigurationManager.ConnectionStrings["ZwConn"].ConnectionString;
        //对应配置文件如下：
        //<connectionStrings>
